...
Definitely not.  In theory, Galveston should have more extreme weather due to its more coastal location, but in practice, Alvin has a more extreme distribution.  This is an example of how domain knowledge is critical for regional analysis, as our empirical observations run in contradiction to it. 
